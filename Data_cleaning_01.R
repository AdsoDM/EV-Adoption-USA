...
#Carga de datos
ev_adoption <- read.csv("E:/Oscar/DataScience/Kryterion/Trabajo final/EV Adoption USA/data/EV_data.csv")
...
set.seed(123) #hasta que no se cambie de semilla, se utilizara esta semilla para cualquier comando de pseudo aleatorización que se use en adelante

#Creamos el cuchillo para sepàrar los datos entre training y test
...
ggplot(data = ev_adoption_01, aes(x=Index, y = fuel_economy))+ geom_line(aes(color = fuel_economy))+labs(x="Index", y="Consumo medio de los vehículos del estado")
ggplot(data = ev_adoption_01, aes(x=year, y = fuel_economy))+ geom_line(aes(color = fuel_economy))+labs(x="Year", y="Consumo medio de los vehículos del estado")

#Análisis de la variable fuel_economy
...
#dibujamos la evolución de la variable 'fuel_economy'
ggplot(data = ev_adoption_01, aes(x=year, y = fuel_economy))+ geom_line(aes(color = fuel_economy))+labs(x="Year", y="Consumo medio de combustible de los vehículos de EEUU")
ggplot(data = ev_adoption_01, aes(x=Index, y = fuel_economy))+ geom_line(aes(color = fuel_economy))+labs(x="Index", y="Consumo medio de combustible de los vehículos de EEUU")
...
ev_adoption_01 %>% plot_normality(fuel_economy) #Es una función quasi-normal
...
#Análisis de la variable Incentives
ggplot(data = ev_adoption_01, aes(x=year, y = Incentives))+ geom_line(aes(color = Incentives))+labs(x="Year", y="Presencia de incentivos por parte del Estado")
...
#Análisis de la variable Number.of.Metro.Organizing.Committees
ggplot(data = ev_adoption_01, aes(x=year, y = Number.of.Metro.Organizing.Committees))+ geom_line(aes(color = Number.of.Metro.Organizing.Committees))+labs(x="Year", y="Número de comités de organización metropolitano")
ggplot(data = ev_adoption_01, aes(x=Index, y = Number.of.Metro.Organizing.Committees))+ geom_line(aes(color = Number.of.Metro.Organizing.Committees))+labs(x="Index", y="Número de comités de organización metropolitano")
...
##Análisis de la variable affectweather
ggplot(data = ev_adoption_01, aes(x=year, y = affectweather))+ geom_line(aes(color = affectweather))+labs(x="Year", y="Medida de sensibilidad o precupacion por el cambio climático")
ggplot(data = ev_adoption_01, aes(x=Index, y = affectweather))+ geom_line(aes(color = affectweather))+labs(x="Index", y="Medida de sensibilidad o precupacion por el cambio climático")
...
ev_adoption_03 %>% plot_normality(affectweather) #Es una función quasi-normal
...
#Compruebo normalidad
ev_adoption_04 %>% plot_normality(affectweather) #Es una función quasi-normal
...
ina <- is.na(unlist(ev_adoption_04)) #crea un vector con los valores 'not available' del dataset
sum(ina)

#Variable DEVHarm
ggplot(data = ev_adoption_04, aes(x=year, y = devharm))+ geom_line(aes(color = devharm))+labs(x="Year", y="Medida de sensibilidad o precupacion por el impacto del cambio climatico en el crecimiento económico")
ggplot(data = ev_adoption_04, aes(x=Index, y = devharm))+ geom_line(aes(color = devharm))+labs(x="Index", y="Medida de sensibilidad o precupacion por el impacto del cambio climatico en el crecimiento económico")
...
#Compruebo normalidad
ev_adoption_04 %>% plot_normality(devharm) #Es una función quasi-normal
...
ev_adoption_05 <- ev_adoption_04 %>%
  ...
  mutate(
    devharm = imputar_con_tendencia(devharm, year, c(2018,2019),c(2016,2017)) # Aplicamos nuestra función a las columnas devharm y year
  ) %>%
...
ggplot(data = ev_adoption_05, aes(x=year, y = devharm))+ geom_line(aes(color = devharm))+labs(x="Year", y="Medida de sensibilidad o precupacion por el impacto del cambio climatico en el crecimiento económico")
ggplot(data = ev_adoption_05, aes(x=Index, y = devharm))+ geom_line(aes(color = devharm))+labs(x="Index", y="Medida de sensibilidad o precupacion por el impacto del cambio climatico en el crecimiento económico")
ggplot(data = ev_adoption_05, aes(x=devharm))+ 
  geom_histogram(bins=20, fill = "darkcyan", color= "white",alpha=0.9) +
  labs(title= "Medida de sensibilidad o precupacion por el cambio climático", x="Sensibilidad", y="Frecuencia") +
  theme_minimal()
ev_adoption_05 %>% plot_normality(devharm) #Es una función quasi-normal
...
#Variable Discuss
ggplot(data = ev_adoption_05, aes(x=state, y = discuss))+ geom_line(aes(color = discuss))+labs(x="Year", y="Medida de la frecuencia con la que la gente discute sobre asuntos medioambientales")
ggplot(data = ev_adoption_05, aes(x=Index, y = discuss))+ geom_line(aes(color = discuss))+labs(x="Index", y="Medida de la frecuencia con la que la gente discute sobre asuntos medioambientales")
ggplot(data = ev_adoption_05, aes(x=devharm))+ 
  geom_histogram(bins=20, fill = "darkcyan", color= "white",alpha=0.9) +
  ...
  theme_minimal()
ev_adoption_05 %>% plot_normality(discuss) #Es una función quasi-normal
...
#Compruebo normalidad y plots
ggplot(data = ev_adoption_06, aes(x=state, y = discuss))+ geom_line(aes(color = discuss))+labs(x="Year", y="Medida de la frecuencia con la que la gente discute sobre asuntos medioambientales")
ggplot(data = ev_adoption_06, aes(x=Index, y = discuss))+ geom_line(aes(color = discuss))+labs(x="Index", y="Medida de la frecuencia con la que la gente discute sobre asuntos medioambientales")
ggplot(data = ev_adoption_06, aes(x=discuss))+ 
  geom_histogram(bins=20, fill = "darkcyan", color= "white",alpha=0.9) +
  labs(title= "Medida de la frecuencia con la que la gente discute sobre asuntos medioambientales", x="Sensibilidad", y="Frecuencia") +
  theme_minimal()
ev_adoption_06 %>% plot_normality(discuss) #Es una función quasi-normal
resultado_shapiro <- shapiro.test(ev_adoption_06$discuss)
print(resultado_shapiro)

#Variable exp
ggplot(data = ev_adoption_06, aes(x=state, y = exp))+ geom_line(aes(color = exp))+labs(x="state", y="Medida de la experiencia y conocimiento sobre asuntos medioambientales")
ggplot(data = ev_adoption_06, aes(x=year, y = exp))+ geom_line(aes(color = exp))+labs(x="Year", y="Medida de la experiencia y conocimiento sobre asuntos medioambientales")
ggplot(data = ev_adoption_06, aes(x=Index, y = exp))+ geom_line(aes(color = exp))+labs(x="Index", y="Medida de la experiencia y conocimiento sobre asuntos medioambientales")
ggplot(data = ev_adoption_06, aes(x=exp))+ 
  ...
  theme_minimal()
ev_adoption_06 %>% plot_normality(exp) #Es una función quasi-normal
...
ggplot(data = ev_adoption_07, aes(x=state, y = exp))+ geom_line(aes(color = exp))+labs(x="state", y="Medida de la experiencia y conocimiento sobre asuntos medioambientales")
ggplot(data = ev_adoption_07, aes(x=year, y = exp))+ geom_line(aes(color = exp))+labs(x="Year", y="Medida de la experiencia y conocimiento sobre asuntos medioambientales")
ggplot(data = ev_adoption_07, aes(x=Index, y = exp))+ geom_line(aes(color = exp))+labs(x="Index", y="Medida de la experiencia y conocimiento sobre asuntos medioambientales")
ggplot(data = ev_adoption_07, aes(x=exp))+ 
  geom_histogram(bins=20, fill = "darkcyan", color= "white",alpha=0.9) +
  labs(title= "Medida de la experiencia y conocimiento sobre asuntos medioambientales", x="Conocimiento", y="Frecuencia") +
  theme_minimal()
ev_adoption_07 %>% plot_normality(exp) #Es una función quasi-normal
resultado_shapiro <- shapiro.test(ev_adoption_07$exp)
print(resultado_shapiro)

#Variable localofficials
ggplot(data = ev_adoption_07, aes(x=state, y = localofficials))+ geom_line(aes(color = localofficials))+labs(x="state", y="Medida de la confianza en las oficinas locales de medioambiente")
ggplot(data = ev_adoption_07, aes(x=year, y = localofficials))+ geom_line(aes(color = exp))+labs(x="Year", y="Medida de la confianza en las oficinas locales de medioambiente")
ggplot(data = ev_adoption_07, aes(x=Index, y = localofficials))+ geom_line(aes(color = exp))+labs(x="Index", y="Medida de la confianza en las oficinas locales de medioambiente")
ggplot(data = ev_adoption_07, aes(x=localofficials))+ 
  ...
  theme_minimal()
ev_adoption_07 %>% plot_normality(localofficials) #Es una función quasi-normal
...
#Compruebo normalidad y grafico
ggplot(data = ev_adoption_08, aes(x=state, y = localofficials))+ geom_line(aes(color = localofficials))+labs(x="state", y="Medida de la confianza en las oficinas locales de medioambiente")
ggplot(data = ev_adoption_08, aes(x=year, y = localofficials))+ geom_line(aes(color = localofficials))+labs(x="Year", y="Medida de la confianza en las oficinas locales de medioambiente")
ggplot(data = ev_adoption_08, aes(x=Index, y = localofficials))+ geom_line(aes(color = localofficials))+labs(x="Index", y="Medida de la confianza en las oficinas locales de medioambiente")
ggplot(data = ev_adoption_08, aes(x=localofficials))+ 
  geom_histogram(bins=20, fill = "darkcyan", color= "white",alpha=0.9) +
  labs(title= "Medida de la confianza en las oficinas locales de medioambiente", x="Conocimiento", y="Frecuencia") +
  theme_minimal()
ev_adoption_08 %>% plot_normality(localofficials) #Es una función quasi-normal
resultado_shapiro <- shapiro.test(ev_adoption_08$localofficials)
print(resultado_shapiro)

#Variable personal
ggplot(data = ev_adoption_08, aes(x=state, y = personal))+ geom_line(aes(color = personal))+labs(x="state", y="Medida de la responsabilidad personal hacia el medioambiente")
ggplot(data = ev_adoption_08, aes(x=year, y = personal))+ geom_line(aes(color = personal))+labs(x="Year", y="Medida de la responsabilidad personal hacia el medioambiente")
ggplot(data = ev_adoption_08, aes(x=Index, y = personal))+ geom_line(aes(color = personal))+labs(x="Index", y="Medida de la responsabilidad personal hacia el medioambiente")
ggplot(data = ev_adoption_08, aes(x=personal))+ 
  ...
  theme_minimal()
ev_adoption_08 %>% plot_normality(personal) #Es una función quasi-normal
...
#Compruebo normalidad y grafico
ggplot(data = ev_adoption_09, aes(x=state, y = personal))+ geom_line(aes(color = personal))+labs(x="state", y="Medida de la responsabilidad personal hacia el medioambiente")
ggplot(data = ev_adoption_09, aes(x=year, y = personal))+ geom_line(aes(color = personal))+labs(x="Year", y="Medida de la responsabilidad personal hacia el medioambiente")
ggplot(data = ev_adoption_09, aes(x=Index, y = personal))+ geom_line(aes(color = personal))+labs(x="Index", y="Medida de la responsabilidad personal hacia el medioambiente")
ggplot(data = ev_adoption_09, aes(x=personal))+ 
  geom_histogram(bins=20, fill = "darkcyan", color= "white",alpha=0.9) +
  labs(title= "Medida de la responsabilidad personal hacia el medioambiente", x="Responsabilidad", y="Frecuencia") +
  theme_minimal()
ev_adoption_09 %>% plot_normality(personal) #Es una función quasi-normal
resultado_shapiro <- shapiro.test(ev_adoption_09$personal)
print(resultado_shapiro)

#Variable reducetax
ggplot(data = ev_adoption_09, aes(x=state, y = reducetax))+ geom_line(aes(color = reducetax))+labs(x="state", y="Medida del apoyo para reducir impuestos con políticas medioambientales")
ggplot(data = ev_adoption_09, aes(x=year, y = reducetax))+ geom_line(aes(color = reducetax))+labs(x="Year", y="Medida del apoyo para reducir impuestos con políticas medioambientales")
ggplot(data = ev_adoption_09, aes(x=Index, y = reducetax))+ geom_line(aes(color = reducetax))+labs(x="Index", y="Medida del apoyo para reducir impuestos con políticas medioambientales")
ggplot(data = ev_adoption_09, aes(x=reducetax))+ 
  ...
  theme_minimal()
ev_adoption_09 %>% plot_normality(reducetax) #Es una función quasi-normal
...
#Compruebo normalidad y grafico
ggplot(data = ev_adoption_10, aes(x=state, y = reducetax))+ geom_line(aes(color = reducetax))+labs(x="state", y="Medida del apoyo para reducir impuestos con políticas medioambientales")
ggplot(data = ev_adoption_10, aes(x=year, y = reducetax))+ geom_line(aes(color = reducetax))+labs(x="Year", y="Medida del apoyo para reducir impuestos con políticas medioambientales")
ggplot(data = ev_adoption_10, aes(x=Index, y = reducetax))+ geom_line(aes(color = reducetax))+labs(x="Index", y="Medida del apoyo para reducir impuestos con políticas medioambientales")
ggplot(data = ev_adoption_10, aes(x=reducetax))+ 
  geom_histogram(bins=20, fill = "darkcyan", color= "white",alpha=0.9) +
  labs(title= "Medida del apoyo para reducir impuestos con políticas medioambientales", x="Reduccion tasas", y="Frecuencia") +
  theme_minimal()
ev_adoption_10 %>% plot_normality(reducetax) #Es una función quasi-normal
resultado_shapiro <- shapiro.test(ev_adoption_10$reducetax)
print(resultado_shapiro)

#Variable regulate
ggplot(data = ev_adoption_10, aes(x=state, y = regulate))+ geom_line(aes(color = regulate))+labs(x="state", y="Medida del apoyo del gobierno a regulaciones medioambientales")
ggplot(data = ev_adoption_10, aes(x=year, y = regulate))+ geom_line(aes(color = regulate))+labs(x="Year", y="Medida del apoyo del gobierno a regulaciones medioambientales")
ggplot(data = ev_adoption_10, aes(x=Index, y = regulate))+ geom_line(aes(color = regulate))+labs(x="Index", y="Medida del apoyo del gobierno a regulaciones medioambientales")
ggplot(data = ev_adoption_10, aes(x=regulate))+ 
  ...
  theme_minimal()
ev_adoption_10 %>% plot_normality(regulate) #Es una función quasi-normal
...
ev_adoption_11 <- ev_adoption_10 %>%
  group_by(state) %>%  # Agrupamos por estado para que la función se aplique a cada uno por separado
  mutate(
    regulate = imputar_con_tendencia(regulate, year, c(2018,2019,2020), c(2016,2017)) # Aplicamos nuestra función a las columnas devharm y year
  ) %>%
  ungroup() # Desagrupamos como buena práctica
...
#Compruebo normalidad y grafico
ggplot(data = ev_adoption_11, aes(x=state, y = regulate))+ geom_line(aes(color = regulate))+labs(x="state", y="Medida del apoyo del gobierno a regulaciones medioambientales")
ggplot(data = ev_adoption_11, aes(x=year, y = regulate))+ geom_line(aes(color = regulate))+labs(x="Year", y="Medida del apoyo del gobierno a regulaciones medioambientales")
ggplot(data = ev_adoption_11, aes(x=Index, y = regulate))+ geom_line(aes(color = regulate))+labs(x="Index", y="Medida del apoyo del gobierno a regulaciones medioambientales")
ggplot(data = ev_adoption_11, aes(x=regulate))+ 
  ...
  theme_minimal()
ev_adoption_11 %>% plot_normality(regulate) #Es una función quasi-normal
resultado_shapiro <- shapiro.test(ev_adoption_11$regulate)
print(resultado_shapiro)

#Varariable worried
ggplot(data = ev_adoption_11, aes(x=state, y = worried))+ geom_line(aes(color = worried))+labs(x="state", y="Medida de la preocupación por problemas medioambientales")
ggplot(data = ev_adoption_11, aes(x=year, y = worried))+ geom_line(aes(color = worried))+labs(x="Year", y="Medida de la preocupación por problemas medioambientales")
ggplot(data = ev_adoption_11, aes(x=Index, y = worried))+ geom_line(aes(color = worried))+labs(x="Index", y="Medida de la preocupación por problemas medioambientales")
ggplot(data = ev_adoption_11, aes(x=worried))+ 
  ...
  theme_minimal()
ev_adoption_11 %>% plot_normality(worried) #Es una función quasi-normal
...
#Compruebo normalidad y grafico
ggplot(data = ev_adoption_12, aes(x=state, y = worried))+ geom_line(aes(color = worried))+labs(x="state", y="Medida de la preocupación por problemas medioambientales")
ggplot(data = ev_adoption_12, aes(x=year, y = worried))+ geom_line(aes(color = worried))+labs(x="Year", y="Medida de la preocupación por problemas medioambientales")
ggplot(data = ev_adoption_12, aes(x=Index, y = worried))+ geom_line(aes(color = worried))+labs(x="Index", y="Medida de la preocupación por problemas medioambientales")
ggplot(data = ev_adoption_12, aes(x=worried))+ 
  geom_histogram(bins=20, fill = "darkcyan", color= "white",alpha=0.9) +
  labs(title= "Medida de la preocupación por problemas medioambientales", x="Preocupacion", y="Frecuencia") +
  theme_minimal()
ev_adoption_12 %>% plot_normality(worried) #Es una función quasi-normal
resultado_shapiro <- shapiro.test(ev_adoption_12$worried)
print(resultado_shapiro)

#Variable gasoline_price_per_gallon
ggplot(data = ev_adoption_12, aes(x=state, y = gasoline_price_per_gallon))+ geom_line(aes(color = gasoline_price_per_gallon))+labs(x="state", y="Precio medio de la gasolina en el estado")
ggplot(data = ev_adoption_12, aes(x=year, y = gasoline_price_per_gallon))+ geom_line(aes(color = gasoline_price_per_gallon))+labs(x="Year", y="Precio medio de la gasolina en el estado")
ggplot(data = ev_adoption_12, aes(x=Index, y = gasoline_price_per_gallon))+ geom_line(aes(color = gasoline_price_per_gallon))+labs(x="Index", y="Precio medio de la gasolina en el estado")
ggplot(data = ev_adoption_12, aes(x=gasoline_price_per_gallon))+ 
  ...
  theme_minimal()
ev_adoption_12 %>% plot_normality(gasoline_price_per_gallon) #Es una función quasi-normal
...
ggplot(data = ev_adoption_13, aes(x=state, y = gasoline_price_per_gallon))+ geom_line(aes(color = gasoline_price_per_gallon))+labs(x="state", y="Precio medio de la gasolina en el estado")
ggplot(data = ev_adoption_13, aes(x=year, y = gasoline_price_per_gallon))+ geom_line(aes(color = gasoline_price_per_gallon))+labs(x="Year", y="Precio medio de la gasolina en el estado")
ggplot(data = ev_adoption_13, aes(x=Index, y = gasoline_price_per_gallon))+ geom_line(aes(color = gasoline_price_per_gallon))+labs(x="Index", y="Precio medio de la gasolina en el estado")
ggplot(data = ev_adoption_13, aes(x=gasoline_price_per_gallon))+ 
  geom_histogram(bins=20, fill = "darkcyan", color= "white",alpha=0.9) +
  labs(title= "Precio medio de la gasolina en el estado", x="Precio gasolina", y="Frecuencia") +
  theme_minimal()
ev_adoption_13 %>% plot_normality(gasoline_price_per_gallon) #Es una función quasi-normal
resultado_shapiro <- shapiro.test(ev_adoption_13$gasoline_price_per_gallon)
print(resultado_shapiro)

#Variable Trucks
ggplot(data = ev_adoption_13, aes(x=state, y = Trucks))+ geom_line(aes(color = Trucks))+labs(x="state", y="Número de camiones")
ggplot(data = ev_adoption_13, aes(x=year, y = Trucks))+ geom_line(aes(color = Trucks))+labs(x="Year", y="Número de camiones")
ggplot(data = ev_adoption_13, aes(x=Index, y = Trucks))+ geom_line(aes(color = Trucks))+labs(x="Index", y="Número de camiones")
ggplot(data = ev_adoption_13, aes(x=Trucks))+ 
  geom_histogram(bins=20, fill = "darkcyan", color= "white",alpha=0.9) +
  labs(title= "Número de camiones", x="Camiones", y="Frecuencia") +
  theme_minimal()
ev_adoption_13 %>% plot_normality(Trucks) #Es una función quasi-normal
...
#Comrpuebo normalidad y grafico
ggplot(data = ev_adoption_14, aes(x=state, y = Trucks))+ geom_line(aes(color = Trucks))+labs(x="state", y="Número de camiones")
ggplot(data = ev_adoption_14, aes(x=year, y = Trucks))+ geom_line(aes(color = Trucks))+labs(x="Year", y="Número de camiones")
ggplot(data = ev_adoption_14, aes(x=Index, y = Trucks))+ geom_line(aes(color = Trucks))+labs(x="Index", y="Número de camiones")
ggplot(data = ev_adoption_14, aes(x=Trucks))+ 
  geom_histogram(bins=20, fill = "darkcyan", color= "white",alpha=0.9) +
  labs(title= "Número de camiones", x="Camiones", y="Frecuencia") +
  theme_minimal()
ev_adoption_14 %>% plot_normality(Trucks) #Es una función quasi-normal
...
#Comrpuebo normalidad y grafico
ggplot(data = ev_adoption_15, aes(x=state, y = Trucks))+ geom_line(aes(color = Trucks))+labs(x="state", y="Número de camiones")
ggplot(data = ev_adoption_15, aes(x=year, y = Trucks))+ geom_line(aes(color = Trucks))+labs(x="Year", y="Número de camiones")
ggplot(data = ev_adoption_15, aes(x=Index, y = Trucks))+ geom_line(aes(color = Trucks))+labs(x="Index", y="Número de camiones")
ggplot(data = ev_adoption_15, aes(x=Trucks))+ 
  geom_histogram(bins=20, fill = "darkcyan", color= "white",alpha=0.9) +
  labs(title= "Número de camiones", x="Camiones", y="Frecuencia") +
  theme_minimal()
ev_adoption_15 %>% plot_normality(Trucks) #Es una función quasi-normal
...
write.csv(ev_adoption_17, file = "E:/Oscar/DataScience/Kryterion/Trabajo final/EV Adoption USA/data/ev_adoption_clean.csv",row.names=FALSE)
